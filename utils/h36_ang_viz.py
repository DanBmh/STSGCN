...
from utils.data_utils import define_actions, expmap2xyz_torch
...
def visualize(
    input_n, output_n, visualize_from, path, modello, device, n_viz, skip_rate, actions
):

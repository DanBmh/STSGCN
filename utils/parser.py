...
parser.add_argument(
    "--output_n", type=int, default=10, help="number of model's output frames"
)
parser.add_argument(
    "--skip_rate",
    type=int,
...
parser.add_argument(
    "--input_dim", type=int, default=3, help="dimensions of the input coordinates"
)
parser.add_argument(
...
parser.add_argument(
    "--lr", type=int, default=1e-02, help="Learning rate of the optimizer"
)
parser.add_argument(
...
parser.add_argument(
    "--model_path",
    type=str,
    default="./checkpoints/CKPT_3D_H36M",
...
parser.add_argument(
    ...
    type=int,
    default="2",
    help="Numbers of sequences to visaluze for each action",
)
